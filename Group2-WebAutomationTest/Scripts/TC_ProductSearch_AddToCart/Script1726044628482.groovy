...
WebUI.setText(findTestObject('Object Repository/Page_JPetStore Demo/input__keyword'), 'dog')

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/input__searchProducts'))

WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/font_K9-BD-01'))
...
WebUI.click(findTestObject('Object Repository/Page_JPetStore Demo/div_'))
